          ...
          {!user && (
            <div className="pt-4 border-t border-[var(--border-subtle)]">
              <button
                ...
                className="w-full py-2 bg-[var(--bg-page-deep)] hover:bg-[var(--bg-elevated)] border border-[var(--border-subtle)] text-xs font-bold text-[var(--text-secondary)] hover:text-[var(--text-primary)] rounded-xl transition flex items-center justify-center space-x-1.5 cursor-pointer"
              >
