...
export const MINIMUM_BID_AMOUNT_USD = 2; // Canonical minimum bid ($2 USD)
export const MINIMUM_BID_AMOUNT_INR = 2; // Compatibility alias
export const MINIMUM_BID_CENTS = 200; // In integer minor units (200 cents)
